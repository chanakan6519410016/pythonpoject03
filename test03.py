#ให้ทำโปรแกรมป้อนจำนวนเงิน และจำนวนคนทางแป้มพิมพ์ และแสดงผลออกมาว่า
...
print('จำนวนเงิน',round(float(money),),'บาท จำนวนคน ',person,'คน ต้องหารกันคนละ',round(float(money)/int(person),2),'บาท')
